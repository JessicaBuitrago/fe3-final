...
import './Form.css'; // Importa el archivo CSS para aplicar estilos al formulario de formo

// Componente de formulario de formo
const Form = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (name.length > 5 && /\S+@\S+\.\S+/.test(email)) {
      ...
      setSuccessMessage(`Gracias ${name}, te formaremos cuando antes vía mail.`);
  ...
  return (
    <div className="form-container"> {/* Contenedor principal del formulario de formo */}
      <h1>formo</h1> {/* Título del formulario */}
...
export default Form; // Exporta el componente form para que pueda ser importado en otros archivos
